	...
	var context="<%=request.getContextPath()%>";
	 $(function() {
		 ...
		 function makeDir(dirName){
				...
				dirName = checkString(dirName);
			 $.ajax({
					type: "GET",
					url: context + "/service/hdfs/makeDir",
					data: "clusterId="+clusterId+"&path="+path+"&dirName="+dirName+"&str_user=" + str_user+ "&str_group=" + str_group+ "&str_other=" + str_other,
					success: function(data) {
						if(data) {
							dialog.close();
...
<body>
	<form class="form-horizontal"  id="saveForm" onsubmit="return false">
		...
		<div class="form-group">
			<label for="dirName" class="col-xs-3 col-md-3 control-label text-right"><span class="required">*</span>目录名称：</label>
			<div class="col-xs-8 col-md-8">
				<input type="text" class="form-control ue-form Validform_input" id="dirName"
						name="dirName" value=""  datatype="fileName" errormsg="名称不符合规范！" nullmsg="名称不能为空" />
		...
		<div class="form-group">
			...
			<div class="form-group self_define_calue">
		         ...
		         <div class="checkbox col-xs-8 col-md-8 text-left">&nbsp;&nbsp;
		                ...
		                &nbsp;&nbsp;&nbsp;&nbsp;
		                <label><input name="checkbox_all" type="checkbox" value="1">x</label>
		          </div>
			</div>
			<div class="form-group self_define_calue">
		         ...
		         <div class="checkbox col-xs-8 col-md-8 text-left">&nbsp;&nbsp;
		                ...
		                &nbsp;&nbsp;&nbsp;&nbsp;
		                <label><input name="checkbox_group" type="checkbox" value="1">x</label>
		          </div>
			</div>
			<div class="form-group self_define_calue">
		         ...
		         <div class="checkbox col-xs-8 col-md-8 text-left">&nbsp;&nbsp;
		                ...
		                &nbsp;&nbsp;&nbsp;&nbsp;
		                <label><input name="checkbox_other" type="checkbox" value="1">x</label>
		          </div>
		 </div>
